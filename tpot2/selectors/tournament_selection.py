...
def tournament_selection(scores, k, rng_=None, n_parents=1, tournament_size=5, score_index=0):
    ...
    score_index = "average" # as we intend to aggregate selection scores to perform tournament selections, note that 'scores' here contains selection set evaluations.
